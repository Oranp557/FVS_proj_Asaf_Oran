...
def run_nusmv_and_check(filename,bound=20):
    ...
    commands = "\n".join([
        ...
        "build_boolean_model",
        "bmc_setup",
        f"check_ltlspec_bmc -k {bound}",  # ← add your 50‐step bound here
        "quit"
    ]) + "\n"
    try:
...
def run_skoban(out_dir, boards):
    ...
    for idx, board in enumerate(boards, start=1):
        ...
        try:
            ...
            winnable = run_nusmv_and_check(fname)
            print(f"--> Board {idx} is {'winnable' if winnable else 'NOT winnable'}")
...
if __name__ == "__main__":
    ...
    out_dir = r"G:\My Drive\Asaf\Masters and PhD\PhD\Courses\Formal Verification and Synthesis - Hilel Kugler\Final Project\main\generated_models"
    #smv_file = "my_model.smv"  # Replace with your actual file
    #run_nusmv_and_check(smv_file)
    run_skoban(out_dir,boards)